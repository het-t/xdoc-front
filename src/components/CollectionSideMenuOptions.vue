    ...
    <base-collection-side-menu>
        ...
        <template #mid-part>
            <div style="padding-top: 6px; padding-bottom: 6px;">
                <base-collection-side-menu-options-item>
                    <template #graphic>
            ...
            <div style="padding-top: 6px; padding-bottom: 6px; box-shadow: rgba(55, 53, 47, 0.09) 0px -1px 0px;">
                ...
                >
                    ...
                    <template #itemMeta>8 shown</template>
                </base-collection-side-menu-options-item>
            </div>
        </template>
    </base-collection-side-menu>
...
import BaseCollectionSideMenuOptionsItem from './BaseCollectionSideMenuOptionsItem.vue';
