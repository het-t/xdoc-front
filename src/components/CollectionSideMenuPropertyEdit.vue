...
onMounted(function() {
    if (propertyEditData.value?.name && propertyEditData.value?.type) {
        state.propertyName = propertyEditData.value.name;
        state.propertyType = propertyEditData.value.type;
    }
})
</script>