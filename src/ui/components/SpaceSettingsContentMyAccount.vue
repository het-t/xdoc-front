<template>
    <space-setting-content-header>My profile</space-setting-content-header>
        ...
        <div style="display: flex; flex-direction: row; align-items: center;">
            ...
            <div style="margin-left: 20px; width: 250px;">
                ...
                <div class="xdoc-focusable-within" style="display: flex; align-items: center; width: 100%; font-size: 14px; line-height: 20px; position: relative; border-radius: 4px; box-shadow: rgba(15, 15, 15, 0.1) 0 0 0 1px inset; background: rgba(242, 241, 238, 0.6); cursor: text; padding: 4px 10px;">
                    <input type="text" style="font-size: inherit; line-height: inherit; border: none; background: none; width: 100%; display: block; resize: none; padding: 0;">
                </div>
            </div>
        </div>
    </div>
    ...
    <space-setting-content-header>Account security</space-setting-content-header>
...
<script setup>
import spaceSettingContentHeader from "@/ui/components/SpaceSettingsContentHeading.vue";
