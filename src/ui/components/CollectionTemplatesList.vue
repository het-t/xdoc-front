<template>
    <div>
        <div 
            @click.stop="handleCloseTemplatesList"
            style="position: fixed; top: 0px; left: 0px; width: 100vw; height: 100vh;"
        ></div>
        
        <div style="position: fixed; pointer-events: none;" 
            :style="{ left: `${dialog.left - 150}px`, top: `${dialog.top}px` }"
        >
            <div style="width: 69px; height: 28px;"></div>

            <div style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; display: flex; flex-direction: column; justify-content: flex-start; align-items: center;">
                <div style="position: relative; top: 100%; pointer-events: auto;">
                    <!-- left -->
                    <div style="display: flex; align-items: center; position: relative; flex-direction: column-reverse; transform-origin: 50% top; top: 4px; opacity: 1; transition-property: opacity, transform; transition-duration: 270ms; transition-timing-function: ease;">
                        <div role="dialog"
                            style="border-radius: 6px; background: white; backdrop-filter: none; position: relative; max-width: calc(-24px + 100vw); box-shadow: rgba(15, 15, 15, 0.05) 0 0 0 1px, rgba(15, 15, 15, 0.1) 0 3px 6px, rgba(15, 15, 15, 0.2) 0 9px 24px; overflow: hidden;"
                        >
