<template>
    ...
    >
        <div style="display: flex; align-items: center; min-height: 28px; font-size: 14px; line-height: 120%; user-select: none; width: 100%;">
            <div 
                v-if="props.graphic"
                style="margin-left: 10px; margin-right: 4px; display: flex; justify-content: center; align-items: center;"
            >
            ...
            <div 
                v-if="props.cols === 3"
                style="margin-left: auto; margin-right: 12px; min-width: 0; flex-shrink: 0; display: flex; align-items: center; color: rgba(55, 53, 47, 0.5); fill: rgba(55, 53, 47, 0.35);"
            >
