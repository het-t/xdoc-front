    ...
    >
        ...
        <template #mid-part>      
            ...
            <div style="padding-top: 6px; padding-bottom: 6px;">              
                ...
                <collection-side-menu-property-edit-multiselect
                    v-if="propertyEdit.type === 'multi_select'"
...
import CollectionSideMenuPropertyEditMultiselect from '../components/CollectionSideMenuPropertyEditMultiselect.vue';
