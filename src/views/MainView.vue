<template>
    <div style="height: 100vh;" class="flex">
        <div :class="menu == false ? 'hide-menu' : ''" id="menu">
            ...
            <div @click.prevent="menu = false" style="text-align: right; margin-top: 4px;">
                <font-awesome-icon :icon="['fas', 'angles-left']" class="menu-hover-bgc" style="padding: 5px;"></font-awesome-icon>
            </div>
...
<!-- position: absolute; left: 8px; -->
        <div style="margin-top: 4px; width: 100%; position: absolute;">
            <font-awesome-icon @click.prevent="menu = true" v-if="menu == false" :icon="['fas', 'bars']" style="padding: 5px; position: relative; left: 8px; width: 18px; height: 18px;" class="menu-hover-bgc"></font-awesome-icon>
        </div>
...
<style scoped>
    ...
    .flex-vertical a:hover,
    .menu-hover-bgc:hover {
